...
var $a={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/open",method:"POST",a:{browser_fingerprint_id:H(!1,I),alternative_browser_fingerprint_id:H(!1,I),identity_id:H(!1,I),link_identifier:H(!1,1),sdk:H(!1,1),options:H(!1,0),initial_referrer:H(!1,1),tracking_disabled:H(!1,4)}},ab={destination:"https://7iofr-cjones.branchbeta.link",endpoint:"/_r",method:"GET",Y:!0,a:{sdk:H(!0,1),_t:H(!1,I),branch_key:H(!0,1)}},bb={destination:"",endpoint:"",method:"GET",f:{link_url:H(!0,1)},a:{click:H(!0,
1)}},cb={destination:"https://cjones.link.beta.branch.io",endpoint:"/c",method:"POST",f:{link_url:H(!0,1)},a:{sdk:H(!1,1),phone:H(!0,1)}},db={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",a:J({amount:H(!0,2),bucket:H(!1,1),calculation_type:H(!0,2),creation_source:H(!0,2),expiration:H(!1,1),location:H(!0,2),prefix:H(!1,1),type:H(!0,1)})},eb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/referralcode",method:"POST",f:{code:H(!0,1)},a:J({})},
fb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/applycode",method:"POST",f:{code:H(!0,1)},a:J({})},gb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/logout",method:"POST",a:J({session_id:H(!0,I)})},hb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/profile",method:"POST",a:J({identity_id:H(!0,I),identity:H(!0,1)})},ib={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/referrals",method:"GET",f:{identity_id:H(!0,I)},a:J({})},jb={destination:"https://cjones.api.beta.branch.io",
endpoint:"/v1/credithistory",method:"GET",a:J({begin_after_id:H(!1,I),bucket:H(!1,1),direction:H(!1,2),length:H(!1,2),link_click_id:H(!1,I)})},kb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/credits",method:"GET",a:J({branch_key:H(!0,1),identity:H(!0,1)})},lb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/redeem",method:"POST",a:J({amount:H(!0,2),bucket:H(!0,1),identity_id:H(!0,I)})},mb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/url",method:"POST",
Aa:"obj",a:J({alias:H(!1,1),campaign:H(!1,1),channel:H(!1,1),data:H(!1,1),feature:H(!1,1),identity_id:H(!0,I),stage:H(!1,1),tags:H(!1,3),type:H(!1,2),source:H(!1,1),instrumentation:H(!1,1)})},nb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/deepview",Y:!0,method:"POST",a:J({campaign:H(!1,1),_t:H(!1,I),channel:H(!1,1),data:H(!0,1),feature:H(!1,1),link_click_id:H(!1,1),open_app:H(!1,4),append_deeplink_path:H(!1,4),stage:H(!1,1),tags:H(!1,3),deepview_type:H(!0,1),source:H(!0,1)})},ob=
{destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/has-app",method:"GET",a:{browser_fingerprint_id:H(!0,I),instrumentation:H(!1,1)}},pb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:H(!0,1),metadata:H(!0,0),initial_referrer:H(!1,1),tracking_disabled:H(!1,4)})},qb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/event",method:"POST",a:J({event:H(!0,1),metadata:H(!1,0),initial_referrer:H(!1,1),commerce_data:H(!0,0)})},rb={destination:"https://cjones.api.beta.branch.io",
endpoint:"/v2/event/standard",method:"POST",a:{name:H(!0,1),user_data:H(!0,1),custom_data:H(!1,1),event_data:H(!1,1),content_items:H(!1,1)}},sb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v2/event/custom",method:"POST",a:{name:H(!0,1),user_data:H(!0,1),custom_data:H(!1,1)}},tb={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/pageview",method:"POST",a:J({event:H(!0,1),metadata:H(!1,0),initial_referrer:H(!1,1),tracking_disabled:H(!1,4),branch_view_id:H(!1,1),no_journeys:H(!1,
4),user_language:H(!1,1),open_app:H(!1,4),has_app_websdk:H(!1,4),source:H(!1,1),feature:H(!1,1),is_iframe:H(!1,4),data:H(!1,0),callback_string:H(!1,1),journey_displayed:H(!1,4),audience_rule_id:H(!1,1),journey_dismissals:H(!1,0)})},ub={destination:"https://cjones.api.beta.branch.io",endpoint:"/v1/dismiss",method:"POST",a:J({event:H(!0,1),metadata:H(!1,0),initial_referrer:H(!1,1),tracking_disabled:H(!1,4),branch_view_id:H(!1,1),no_journeys:H(!1,4),user_language:H(!1,1),open_app:H(!1,4),has_app_websdk:H(!1,
4),source:H(!1,1),feature:H(!1,1),is_iframe:H(!1,4),data:H(!1,0),callback_string:H(!1,1),journey_displayed:H(!1,4),audience_rule_id:H(!1,1),journey_dismissals:H(!1,0)})};function vb(a){for(var b=0;b<a.length;b++){var c=this[a[b]],c="function"===typeof c?c():c;if(c.isEnabled())return c.u={},c}}function K(a){return"branch_session"===a||"branch_session_first"===a?a:"BRANCH_WEBSDK_KEY"+a}function wb(a){return"true"===a?!0:"false"===a?!1:a}function xb(a){return"branch_session"===a||"branch_session_first"===a||0===a.indexOf("BRANCH_WEBSDK_KEY")}function yb(a){a=a.trim();var b=a.indexOf("=");return{name:a.substring(0,b),value:wb(a.substring(b+1,a.length))}}
...
v);return Ib(this.ca,a,b,this.c,function(a,b){c(a,b)})};function V(a){var b=L(a.c);return(b=b&&b.referring_link)?b:(a=a.c.get("click_id"))?"https://cjones.link.beta.branch.io/c/"+a:null}function N(a,b,c){for(var d=0;d<a.g.length;d++)a.g[d].event&&a.g[d].event!==b||a.g[d].listener(b,c)}
...
{browser_fingerprint_id:c.browser_fingerprint_id},function(b,d){b&&(g.i=4,g.l=b.message);b||!d||c.has_app||(c.has_app=!0,Bb(g.c,c),N(g,"didDownloadApp"));a&&a(null,c)})}function k(a){a.link_click_id&&(g.Z=a.link_click_id.toString());a.session_id&&(g.G=a.session_id.toString());a.identity_id&&(g.v=a.identity_id.toString());a.link&&(g.M=a.link);if(a.referring_link){var b=a.referring_link;a.referring_link=b?"http"!==b.substring(0,4)?"https://cjones.link.beta.branch.io"+b:b:null}!a.click_id&&a.referring_link&&
(a.click_id=Ea(a.referring_link));g.B=a.browser_fingerprint_id;return a}qa&&(u["init-began-at"]=(Date.now()-window.performance.timing.navigationStart).toString());var g=this;g.j=1;-1<b.indexOf("key_")?g.h=b:g.U=b;c=c&&F(c,"object")?c:{};na=(g.F=c)&&c.retries&&Number.isInteger(c.retries)?c.retries:na;oa=c&&c.retry_delay&&Number.isInteger(c.retry_delay)?c.retry_delay:oa;pa=c&&c.timeout&&Number.isInteger(c.timeout)?c.timeout:pa;r=c&&c.nonce?c.nonce:r;v=c&&c.tracking_disabled&&!0===c.tracking_disabled?
!0:!1;ua=!1;v&&ya(g);b=L(g.c);var l=c&&"undefined"!==typeof c.branch_match_id&&null!==c.branch_match_id?c.branch_match_id:null,m=l||Ia("_branch_match_id")||Fa(),p=!b||!b.identity_id;g.A=!!g.c.get("branch_view_enabled");if(b&&b.session_id&&!m&&!Ia("branchify_url"))Bb(g.c,{data:""}),Bb(g.c,{referring_link:""}),d(),f(e);else{b={sdk:"2.49.0",branch_key:g.h};var t=L(g.c,!0)||{};t.browser_fingerprint_id&&(b._t=t.browser_fingerprint_id);Ha()?g.b($a,{link_identifier:m,browser_fingerprint_id:m||t.browser_fingerprint_id,
